package find_constructioncost_for_highstandard;
import decide.Decide_construction_cost;
import customer_input.Customer_house_construction;
public class Construction_cost_for_highstandard_material 
{
public int fully_automated_home, cost, material_standard, total_area_of_house;
public Construction_cost_for_highstandard_material(int fully_automated_home,int cost, int material_standard,int total_area_of_house)
{
...
public int constructioncost_for_high_standard()
{
