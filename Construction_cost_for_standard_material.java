package find_constructioncost_forstandard;
import decide.Decide_construction_cost;
import customer_input.Customer_house_construction;
public class Construction_cost_for_standard_material
{
public int fully_automated_home, cost, material_standard, total_area_of_house;
public Construction_cost_for_standard_material(int fully_automated_home,int cost,int material_standard,int total_area_of_house)
{
...
public int constructioncost_for_standard()
{
